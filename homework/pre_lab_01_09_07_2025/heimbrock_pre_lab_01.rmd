...
**Task** In the console (look below), type 2+2 and hit enter. What does it return? Type your answer below. **Answer:** 2+2=
...
**Answer** The code is providing a count of classes provided in each term. (I am confused because I don't understand why the terms have such long strings of numbers attached. Shouldn't it be a date? Is it a date?) 
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** Now the courses and classes are arranged in descending order.
...
**Answer** This output also includes department names. The code that changed it is "group_by(term, department)"
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** Now the code shows the term, classes per term and total seats. This provides less information by department, but shows general enrollment trends.
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** Now we have the mean and median of the total seats per term. This provides a broader look at the trends of enrollment and offerings per year. As the textbook says, the mean is more sensitive to extreme ends of data, so that also tells us something.
...
**Answer** Now we're back to having department information. This gives us great information about which departments have more or less enrollment. The data is sorted by mean and median. 
...
1.  Why do the stem/business classes have more classes and seats?

2.  Why does the national institute of aeronautics only have four classes with four seats total?

3.  How do these trends change by year?
